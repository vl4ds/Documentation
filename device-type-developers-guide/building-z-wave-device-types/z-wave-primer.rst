...
`Z-Wave Command Reference <http://www.smartthings.com/developers/z-wave-reference.php>`__. Notice
...
-  `**0x20 Basic** <http://www.smartthings.com/developers/z-wave-reference.php#basicV1>`__ A
...
-  `**0x25 Switch
   Binary** <http://www.smartthings.com/developers/z-wave-reference.php#switchBinaryV1>`__ Control of
   on/off switches.
-  `**0x26 Switch
   Multilevel** <http://www.smartthings.com/developers/z-wave-reference.php#switchMultilevelV3>`__
   Control of dimmer switches.
-  `**0x30 Sensor
   Binary** <http://www.smartthings.com/developers/z-wave-reference.php#sensorBinaryV1>`__ Sensors
   with two states, such as motion detectors and open/closed sensors.
-  `**0x31 Sensor
   Multilevel** <http://www.smartthings.com/developers/z-wave-reference.php#sensorMultilevelV5>`__
   Sensors that report a numeric value, like temperature or illuminance.
-  `**0x32 Meter** <http://www.smartthings.com/developers/z-wave-reference.php#meterV3>`__ Outlets
   and meters that measure energy use.
-  `**0x71
   Alarm/Notification** <http://www.smartthings.com/developers/z-wave-reference.php#notificationV3>`__
   The *Alarm* command class was renamed to *Notification* in version 3.
   Used by sensors and other devices to report events.
-  `**0x70
   Configuration** <http://www.smartthings.com/developers/z-wave-reference.php#configurationV2>`__
   See *Configuration* section below.
-  `**0x80 Battery** <http://www.smartthings.com/developers/z-wave-reference.php#batteryV1>`__
   Battery level reporting for battery powered devices.
-  `**0x84 Wake Up** <http://www.smartthings.com/developers/z-wave-reference.php#wakeUpV2>`__ See
   *Listening and Sleepy Devices* section below.
-  `**0x85
   Association** <http://www.smartthings.com/developers/z-wave-reference.php#associationV2>`__ See
   *Association* section below.
-  `**0x86 Version** <http://www.smartthings.com/developers/z-wave-reference.php#versionV1>`__ All
   devices report their Z-Wave framework and firmware version on
   request.
-  `**0x72 Manufacturer
   Specific** <http://www.smartthings.com/developers/z-wave-reference.php#manufacturerSpecificV2>`__
   All devices report their manufacturer and model (via numeric code).
-  `**0x98 Security** <http://www.smartthings.com/developers/z-wave-reference.php#securityV1>`__
...
-  `**0x60
   Multi-Channel/Multi-Instance** <http://www.smartthings.com/developers/z-wave-reference.php#multiChannelV3>`__
...
interval and send a
`WakeUpNotification <http://www.smartthings.com/developers/z-wave-reference.php#wakeUpV2/wakeUpNotification>`__
to alert other devices that they will be listening for incoming commands
for the next few seconds. The
`WakeUpIntervalSet <http://www.smartthings.com/developers/z-wave-reference.php#wakeUpV2/wakeUpIntervalSet>`__
...
`WakeUpNoMoreInformation <http://www.smartthings.com/developers/z-wave-reference.php#wakeUpV2/wakeUpNoMoreInformation>`__
...
`ConfigurationSet <http://www.smartthings.com/developers/z-wave-reference.php#configurationV2/configurationSet>`__
...
`ConfigurationReport <http://www.smartthings.com/developers/z-wave-reference.php#configurationV2/configurationReport>`__
from the device for the parameter number in question.

Association
-----------

The `Association <http://www.smartthings.com/developers/z-wave-reference.php#associationV2>`__
...
-  Many sensors will send
   `BasicSet <http://www.smartthings.com/developers/z-wave-reference.php#basicV1/basicSet>`__
...
`AssociationRemove <http://www.smartthings.com/developers/z-wave-reference.php#associationV2/associationRemove>`__
to undo it. To associate to a group higher than 1, the device type
handler can send
`AssociationSet <http://www.smartthings.com/developers/z-wave-reference.php#associationV2/associationSet>`__.
